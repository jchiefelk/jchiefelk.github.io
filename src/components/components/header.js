	...
	render() {
	    return (
	      <div style={{display: 'flex', height: 50, backgroundColor: 'black', alignItems: 'center' }}>
	      	...
	      	<a href="https://github.com/jchiefelk" style={{fontSize: 18,fontFamily: 'Courier New' ,color: 'white', position: 'absolute', right: window.innerWidth*(0.2), top: 15, textDecoration: 'none' }}>Github</a>
	      </div>
	    );
	}
